  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-black text-gray-900 dark:text-white">Enrolled Students</h1>
          <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">{students.length} students currently enrolled</p>
        </div>
        <button onClick={fetchEnrolled} className="flex items-center gap-2 px-4 py-2 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white text-sm font-medium transition-colors">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 overflow-hidden">
        {loading ? (
          ...
          <div className="py-16 text-center text-gray-400 dark:text-gray-500">No enrolled students found.</div>
        ) : (
